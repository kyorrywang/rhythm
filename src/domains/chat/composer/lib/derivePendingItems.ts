import type { PendingItem } from '@/domains/chat/composer/types';
import type { Session } from '@/shared/types/schema';
import type { PermissionRequest } from '@/core/permissions/usePermissionStore';
import { getCurrentAsk, getMessageTextContent, getSessionQueueState } from '@/core/sessions/sessionState';
