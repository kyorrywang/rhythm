...
import { DEFAULT_WORKSPACE_PATH, normalizeWorkspacePath, useActiveWorkspace, useWorkspaceStore } from '@/core/workspace/useWorkspaceStore';
import { useSessions, useSessionStore } from '@/core/sessions/useSessionStore';
import { themeRecipes } from '@/ui/theme/recipes';
import { EmptyState, SidebarPage } from '@/ui/components';
