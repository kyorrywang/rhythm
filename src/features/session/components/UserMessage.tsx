  ...
  return (
    ...
    >
      <div className="flex max-w-[82%] flex-col items-end">
        <div className="rounded-[22px] rounded-tr-none bg-slate-900 px-4 py-3 text-[14px] leading-7 text-white shadow-[0_8px_22px_rgba(15,23,42,0.10)] whitespace-pre-wrap select-text">
