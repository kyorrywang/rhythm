  ...
  return (
    ...
    >
      <div className="flex max-w-[82%] flex-col items-end">
        <div className="whitespace-pre-wrap rounded-[var(--theme-radius-card)] rounded-tr-none bg-[var(--theme-accent)] px-[var(--theme-card-padding-x)] py-[var(--theme-card-padding-y)] text-[length:var(--theme-body-size)] leading-7 text-[var(--theme-accent-contrast)] shadow-[var(--theme-shadow-soft)] select-text">
