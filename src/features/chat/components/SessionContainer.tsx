...
import { ComposerBox } from '@/widgets/composer/ComposerBox';
import { UserMessage } from '@/widgets/session-timeline/components/UserMessage';
import { AgentMessage } from '@/widgets/session-timeline/components/AgentMessage';
import { SystemMessage } from '@/widgets/session-timeline/components/SystemMessage';
import { ContextUsagePanel } from '@/widgets/session-timeline/components/ContextUsagePanel';
import { ErrorBanner } from '@/widgets/session-timeline/components/ErrorBanner';
import { useSessionStore, useActiveSession } from '@/features/chat/store/useSessionStore';
import { useAutoScroll } from '@/widgets/session-timeline/hooks/useAutoScroll';
...
import { getMessageTextContent } from '@/features/chat/utils/sessionState';
