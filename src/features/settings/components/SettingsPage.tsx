...
import { useSettingsStore, type AppSettings } from '@/features/settings/store/useSettingsStore';
...
import type { DisplayPreferences, SegmentDisplayConfig } from '@/features/settings/store/useDisplayStore';
