...
import { approvePermission, listSlashCommands } from '@/platform/tauri/api/commands';
...
import { useComposerActions } from '@/features/chat/hooks/useComposerActions';
import { derivePendingItems } from '@/features/chat/utils/derivePendingItems';
import { normalizeSlashCommands } from '@/features/chat/utils/slashCommands';
import { AskDock } from './components/AskDock';
import { MainComposer } from './components/MainComposer';
import { TaskDock } from './components/TaskDock';
import { AppendDock } from './components/AppendDock';
import { getCurrentAsk, getCurrentTasks, getSessionQueueState, getSessionRuntimeState } from '@/features/chat/utils/sessionState';
import type { ComposerSlashCommand } from '@/features/chat/model/types';
