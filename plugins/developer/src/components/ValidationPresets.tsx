      ...
      <div className="space-y-2">
        {presets.map((item) => (
          <Button
            ...
            className="flex w-full items-center gap-2 rounded-[var(--theme-radius-card)] border border-slate-200 bg-white px-3 py-2 text-left text-xs text-slate-600 hover:bg-slate-50"
          >
            <ScrollText size={14} />
