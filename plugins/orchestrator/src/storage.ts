...
function normalizePlanDraft(value: unknown): OrchestratorPlanDraft | null {
  ...
  return {
    ...
    decompositionPrinciples: normalizeStringArray(draft.decompositionPrinciples),
    humanCheckpoints: normalizeStringArray(draft.humanCheckpoints),
    reviewCheckpoints: normalizeStringArray(draft.reviewCheckpoints),
...
function normalizeRun(value: unknown): OrchestratorRun | null {
  ...
  return {
    ...
    confirmedPlan: {
      ...
      decompositionPrinciples: normalizeStringArray(confirmedPlan.decompositionPrinciples),
      humanCheckpoints: normalizeStringArray(confirmedPlan.humanCheckpoints),
      reviewCheckpoints: normalizeStringArray(confirmedPlan.reviewCheckpoints),
      reviewPolicy: confirmedPlan.reviewPolicy || '',
