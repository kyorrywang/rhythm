...
use crate::infra::llm;
use crate::runtime::automation::cron::registry::SharedRegistry;
use crate::runtime::automation::cron::types::CronRunStatus;
use crate::runtime::capabilities::mcp::McpClientManager;
use crate::runtime::capabilities::tools::ToolRegistry;
use crate::runtime::context::prompts::build_runtime_prompt;
...
impl CronRunner {
    ...
    pub async fn run(&self, job: &crate::runtime::automation::cron::types::CronJob) {
