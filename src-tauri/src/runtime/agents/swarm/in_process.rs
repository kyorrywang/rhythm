...
use crate::runtime::agents::{format_task_notification, TaskNotification, TaskNotificationStatus};
...
impl InProcessBackend {
    ...
    pub async fn spawn(&self, config: TeammateSpawnConfig) -> SpawnResult {
        ...
        let task = tokio::spawn(async move {
            ...
            let system_prompt =
                crate::runtime::context::prompts::build_runtime_prompt_with_addition(
                    &settings,
                    &cwd,
