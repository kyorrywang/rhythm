...
pub fn map_to_frontend(settings: RhythmSettings) -> FrontendSettings {
    ...
    FrontendSettings {
        ...
        permission_mode: match settings.policies.permissions.mode {
            crate::domains::permissions::modes::PermissionMode::Default => "default".to_string(),
            crate::domains::permissions::modes::PermissionMode::Plan => "plan".to_string(),
            crate::domains::permissions::modes::PermissionMode::FullAuto => "full_auto".to_string(),
        },
        ...
        mcp_servers: settings
            ...
            .map(|(name, server)| match server {
                crate::platform::mcp::types::McpServerConfig::Stdio(cfg) => {
                ...
                crate::platform::mcp::types::McpServerConfig::Http(cfg) => {
                    FrontendMcpServerConfig {
                        id: name.clone(),
                        name: name.clone(),
                ...
                crate::platform::mcp::types::McpServerConfig::Ws(cfg) => FrontendMcpServerConfig {
                    id: name.clone(),
                    name: name.clone(),
                    transport: "http".to_string(),
                    endpoint: cfg.url.clone(),
...
pub fn map_from_frontend(settings: FrontendSettings) -> RhythmSettings {
    ...
    bundle.policies.permissions = config::PermissionConfig {
        mode: crate::domains::permissions::modes::PermissionMode::from_str(
    ...
    bundle.core.mcp_servers = settings
        ...
        .map(|server| {
            let config = if server.transport == "stdio" {
                crate::platform::mcp::types::McpServerConfig::Stdio(
                    crate::platform::mcp::types::McpStdioServerConfig {
                ...
                crate::platform::mcp::types::McpServerConfig::Http(
                    crate::platform::mcp::types::McpHttpServerConfig {
