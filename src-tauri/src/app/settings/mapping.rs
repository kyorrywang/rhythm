...
use super::dto::{
    FrontendHookConfig, FrontendMcpServerConfig, FrontendProviderConfig, FrontendProviderModel,
    FrontendSettings,
};

pub fn map_to_frontend(settings: RhythmSettings) -> FrontendSettings {
    ...
    FrontendSettings {
        ...
        permission_mode: match settings.policies.permissions.mode {
            crate::runtime::policy::permissions::modes::PermissionMode::Default => {
                "default".to_string()
            }
            crate::runtime::policy::permissions::modes::PermissionMode::Plan => "plan".to_string(),
            crate::runtime::policy::permissions::modes::PermissionMode::FullAuto => {
                "full_auto".to_string()
            }
        },
        ...
        mcp_servers: settings
            ...
            .map(|(name, server)| match server {
                crate::runtime::capabilities::mcp::types::McpServerConfig::Stdio(cfg) => {
                    FrontendMcpServerConfig {
                        id: name.clone(),
                        name: name.clone(),
                ...
                crate::runtime::capabilities::mcp::types::McpServerConfig::Http(cfg) => {
                    FrontendMcpServerConfig {
                        id: name.clone(),
                        name: name.clone(),
                ...
                crate::runtime::capabilities::mcp::types::McpServerConfig::Ws(cfg) => {
                    FrontendMcpServerConfig {
                        id: name.clone(),
                        name: name.clone(),
                        transport: "http".to_string(),
...
pub fn map_from_frontend(settings: FrontendSettings) -> RhythmSettings {
    ...
    bundle.policies.permissions = config::PermissionConfig {
        mode: crate::runtime::policy::permissions::modes::PermissionMode::from_str(
    ...
    bundle.core.mcp_servers = settings
        ...
        .map(|server| {
            let config = if server.transport == "stdio" {
                crate::runtime::capabilities::mcp::types::McpServerConfig::Stdio(
                    crate::runtime::capabilities::mcp::types::McpStdioServerConfig {
                ...
                crate::runtime::capabilities::mcp::types::McpServerConfig::Http(
                    crate::runtime::capabilities::mcp::types::McpHttpServerConfig {
