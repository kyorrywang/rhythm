...
use crate::domains::agents::{format_task_notification, TaskNotification, TaskNotificationStatus};
        ...
        let task = tokio::spawn(async move {
            ...
            let runtime_spec = match config::resolve_runtime_spec(
                ...
                config::RuntimeIntent {
                    ...
                    reasoning: None,
                    permission_mode: config_clone.permission_mode.clone().or_else(|| {
                        agent_def
                            .as_ref()
                ...
                Err(error) => {
                    eprintln!(
                        "[InProcessBackend] failed to resolve runtime spec: {}",
                        error
                    );
                    return;
                }
            ...
            let system_prompt = crate::domains::chat::prompts::build_runtime_prompt_with_addition(
                &settings,
                &cwd,
