...
use crate::domains::tools::BaseTool;
...
pub async fn handle_runtime_rpc(value: &Value, host: Option<&PluginRuntimeHost<'_>>) -> Value {
    ...
    match method {
        "command.execute" => {
            ...
            let registry =
                crate::domains::plugins::command_registry::PluginCommandRegistry::from_plugins(
                    host.plugins,
                );
        ...
        "workspace.readText" => {
            ...
            match crate::domains::tools::context::resolve_and_validate_path(
        ...
        "askUser" => {
            ...
            match crate::domains::tools::ask::AskTool::execute_structured(params, &ctx).await {
        ...
        "spawnSubagent" => {
            ...
            let params = value
                ...
                .cloned()
                .unwrap_or_else(|| serde_json::json!({}));
            let tool = crate::domains::tools::subagent::SubagentTool;
