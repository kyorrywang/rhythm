...
pub async fn execute_plugin_command(
    ...
    let settings = crate::platform::config::load_settings();
    let plugins = crate::domains::plugins::loader::load_plugins(&settings, cwd_path);
    let plugin = plugins
        .iter()
    ...
    let request = PluginSlashRuntimeRequest {
        ...
        slash: crate::domains::slash::types::PluginSlashContributionRuntimeConfig {
