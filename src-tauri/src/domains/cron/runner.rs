...
use crate::domains::chat::prompts::build_runtime_prompt;
use crate::domains::cron::registry::SharedRegistry;
use crate::domains::cron::types::CronRunStatus;
...
impl CronRunner {
    ...
    pub async fn run(&self, job: &crate::domains::cron::types::CronJob) {
    ...
    async fn run_prompt(&self, prompt: &str, cwd: &str) -> (bool, String) {
        ...
        let system_prompt = build_runtime_prompt(&settings, &cwd_path, Some(prompt), &runtime_spec);
