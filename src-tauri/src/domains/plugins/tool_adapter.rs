...
use crate::domains::slash::host_api::{handle_runtime_rpc, PluginRuntimeHost};
use crate::domains::tools::{BaseTool, ToolExecutionContext, ToolResult};
...
pub async fn run_plugin_runtime(
    ...
    let entry_path = crate::domains::tools::context::resolve_and_validate_path(
